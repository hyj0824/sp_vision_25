...
{
// len不包括crc8
constexpr uint8_t get_crc8(const uint8_t * data, uint16_t len)
{
...
// len包括crc8
constexpr bool check_crc8(const uint8_t * data, uint16_t len)
{
  return get_crc8(data, len - 1) == data[len - 1];
}

// len不包括crc16
constexpr uint16_t get_crc16(const uint8_t * data, uint32_t len)
{
...
// len包括crc16
constexpr bool check_crc16(const uint8_t * data, uint32_t len)
{
